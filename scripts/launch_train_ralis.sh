...
for seed in 20 50 82 12 4560
    ...
    --ckpt-path $ckpt_path --data-path $data_path \
    --rl-episodes 100 --rl-buffer 600 --lr-dqn 0.001\
    --dataset 'QB' --lr 0.001 --train-batch-size 32 --val-batch-size 4 --patience 10 \
    --input-size 256 256 --only-last-labeled --budget-labels 480  --num-each-iter 24  --rl-pool 20 --seed $seed
    done
